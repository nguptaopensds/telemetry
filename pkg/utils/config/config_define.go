...
type OsdsApiServer struct {
	...
	BeegoHTTPSCertFile string        `conf:"beego_https_cert_file,/opt/opensds-security/telemetry-cert.pem"`
	BeegoHTTPSKeyFile  string        `conf:"beego_https_key_file,/opt/opensds-security/telemetry-key.pem"`
